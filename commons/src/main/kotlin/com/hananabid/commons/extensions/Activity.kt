...
import com.hananabid.commons.models.*
import com.hananabid.commons.views.MyTextView
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String) {
    Thread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.hananabid.gallery" || applicationId == "com.hananabid.gallery.debug") {
