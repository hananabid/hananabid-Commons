...
import com.hananabid.commons.asynctasks.CopyMoveTask
import com.hananabid.commons.dialogs.ConfirmationDialog
import com.hananabid.commons.dialogs.FileConflictDialog
import com.hananabid.commons.dialogs.WritePermissionDialog
import com.hananabid.commons.extensions.*
import com.hananabid.commons.helpers.*
import com.hananabid.commons.interfaces.CopyMoveListener
import com.hananabid.commons.models.FAQItem
import com.hananabid.commons.models.FileDirItem
import java.io.File
import java.util.*
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.hananabid.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one. Thanks"
